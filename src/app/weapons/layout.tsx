...
const erdtreeFont = localFont({
  ...
  // layout.tsx befindet sich in src/app/weapons/ -> public ist drei Ebenen höher
...
// Die Layout-Komponente für den Waffen-Bereich
  ...
  return (
    ...
    <html lang="en" className={`${erdtreeFont.variable}`}>
      ...
      <body
        ...
        className={`${geistSans.variable} ${geistMono.variable} antialiased h-screen w-screen overflow-x-hidden ${erdtreeFont.className}`}
      >
        ...
        {/* Navigationsleiste mit hervorgehobener Kategorie 'weapons' */}
        <Navbar highLightCategory="weapons"/>
        
        {/* Hauptcontainer für den Inhalt */}
        <div className="flex flex-col flex-grow">
          {/* Header-Bereich mit dem Logo */}
          <header className="w-full flex flex-col items-center pt-8">
            <Image src="/erdtree-cards.png" width={500} height={83} alt="Erdtree Cards" className="w-4/5 max-w-xl md:w-3/4 h-auto" 
