...
/**
 * Metadaten für die Rüstungs-Seite (Armor).
 */
...
/**
 * Layout-Komponente für den Bereich '/armor'.
  ...
  return (
    <html lang="en" className={`${erdtreeFont.variable}`}>
      ...
      >
        ...
        {/* Navigation mit Hervorhebung der Kategorie 'armor' */}
        <Navbar highLightCategory="armor"/>
